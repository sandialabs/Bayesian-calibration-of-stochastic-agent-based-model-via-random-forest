...
sampler.simulation_options.define_simulation_options(
    ...
    updatesigma = 1,
    savedir = "results/",
    results_filename = env+"/results/calibration/calibrator.json",
    save_to_json = True,
)
...
df.to_csv(env+"/results/calibration/calibration.csv",index=False)
...
predictions_h.to_csv(env+"/results/calibration/calibration_predictions_h.csv",index=False,header=False)
predictions_d.to_csv(env+"/results/calibration/calibration_predictions_d.csv",index=False,header=False)
posterior_samples.to_csv(env+"/results/calibration/posterior_samples.csv",index=False)
