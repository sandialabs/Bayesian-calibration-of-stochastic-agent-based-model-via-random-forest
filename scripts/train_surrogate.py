...
# %%
gname = env+"/results/surrogate/gini_importance.csv"
pname = env+"/results/surrogate/permutation_importance.csv"
fname = env+"/results/surrogate/sobol_first_importance.csv"
tname = env+"/results/surrogate/sobol_total_importance.csv"
...
save_name = env+"/plots/surrogate/cross_validation.pdf"
...
save_name = env+"/results/surrogate/parameter_errors.csv"
...
model_name = env+"/results/surrogate/surrogate.pkl"
