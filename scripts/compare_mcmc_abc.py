...
# Load data
# ------------------------------------------------------------------------------
plotdir = env+"/plots/pushforward/"

# Load surrogate
with open(env+"/results/surrogate/surrogate.pkl", "rb") as file:
...
data_pred = pd.read_csv(env+"/data/pushforward_results.csv", index_col=0, header=[0,1]).dropna()
...
params_pred = pd.read_csv(env+"/data/pushforward_parameters.csv", index_col=None)
...
all_scores.to_csv(env+"/results/pushforward/scores.csv")
