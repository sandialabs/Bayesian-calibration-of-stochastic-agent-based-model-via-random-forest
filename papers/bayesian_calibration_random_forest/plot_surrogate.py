...
save_loc = env+"/plots/bayesian_calibration_random_forest/surrogate/"
res_loc = env+"/results/bayesian_calibration_random_forest/surrogate/"
# %%
######################## PCA ##############################
var_exp = .95
...
plt.tight_layout()
plt.savefig(save_loc+"rf_rel_err_hist.pdf")
plt.show()
