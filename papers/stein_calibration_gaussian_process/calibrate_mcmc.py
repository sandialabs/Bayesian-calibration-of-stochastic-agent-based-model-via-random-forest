...
df.to_csv(res_loc+"calibration/mcmc_calibration.csv",index=False)
...
predictions_h.to_csv(res_loc+"calibration/mcmc_calibration_predictions_h.csv",index=False,header=False)
predictions_d.to_csv(res_loc+"calibration/mcmc_calibration_predictions_d.csv",index=False,header=False)
posterior_samples.to_csv(res_loc+"calibration/mcmc_posterior_samples.csv",index=False)
